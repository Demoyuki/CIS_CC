/*	This program must perform all the functionality from Parts 1 - 3 above, using the Student structure
discussed in Part 4.

	Filename: final05Marrujo.c
...
// Reports 
void reportOutput(struct Student *s, int numCurrentStudents, int sortOption);
...
void searchForStudentLastName(struct Student *s, int numCurrentStudents);
void searchOptionsLastName(struct Student *s, int numCurrentStudents);
...
int main(void)
{
    ...
    {   
        ...
        if (isdigit(userInput) && userInput == '1')
        {
			...
			reportOutput(students, numCurrentStudents, sortOption);
		...
		{
		    printf("\nAvailable Student Information\nLast	   First");
		    searchOptionsLastName(students, numCurrentStudents);
			searchForStudentLastName(students, numCurrentStudents);
		}// else if
...
/* =================================================================================
    ...
    Outputs: None - uses pass-by-reference
    Date: April 30th, 2023
         o changed from variables to structure 05/05/23
====================================================================================*/
void searchForStudentLastName(struct Student *s, int numCurrentStudents)
{
    // Local Definitions ==============
    ...
    while (isValid == false && currCount < numCurrentStudents && quit == false)
    {
        if (strcmp(searchLastName, s[row].lastName) == 0)
        {
            isValid = true;
        }// if
        else
...
void searchOptionsLastName(struct Student *s, int numCurrentStudents) 
{
    ...
    for (int row = 0; row < numCurrentStudents; row++) 
    {
        printf("\n%-9s  %-9s ", s[row].lastName, s[row].firstName);
    }// for
