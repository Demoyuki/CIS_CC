/*	This program modifys Project 8 to add:
		...
		2) "Show full report" option should show the students sorted by last name.
		3) add and search functionality is updated for the change in data

	Filename: project11Marrujo.c
	Changes made by: Victor Marrujo
	Date: April 19nd, 2023 (completed on April 26th)
	
    project08guilmette.c by Dan Guilmette was used as a baseline for this project.
*/
#include <stdio.h>
#include <ctype.h>
#include <stdlib.h>
...
void reportOutput(char firstName[][20], char lastName[][20], int studentID[], int studentScores[][NUM_SCORES], 
...
void searchForStudent(char lastName[][20], char firstName[][20], int studentID[], int studentScores[][NUM_SCORES], int studentMinScore[], int studentMaxScore[], 
...
int main(void)
{
    ...
    int studentScores[MAX_STUDENTS][numScores];
    ...
    readData(firstName, lastName, studentID, studentScores, numInitialStudents);
    ...
    {   
		...
		{
			searchForStudent( lastName, firstName, studentID, studentScores, studentMinScore, studentMaxScore, studentAvg, numCurrentStudents, studentLetterGrade);
		}// else if
