/*	This program modifys Project 11 to modify the full report menu item so that:
        1) You display a new submenu for the user to select from the following options.
        2) Display the full report by last name (ascending order)
        3) Display the full report by last name (descending order)
        4) Display the full report by student ID (ascending order)
        5) Display the full report by student ID (descending order)

        
	Filename: final03Marrujo.c
...
void reportOutput( char lastName[][20], char firstName[][20], int studentID[ ], int studentScores[ ][NUM_SCORES], 
								...
								char studentLetterGrade[ ],int sortOption);	
...
int main(void)
{
    ...
    {   
        ...
        if (isdigit(userInput) && userInput == '1')
        {
            ...
            printf("1. Last name (ascending order) \n");
            printf("2. Last name (descending order) \n");
            printf("3. Student ID (ascending order) \n");
            printf("4. Student ID (descending order) \n\n");
            printf("Your Selection: ");
            scanf(" %d", &sortOption);
			reportOutput( lastName, firstName, studentID, studentScores, studentMinScore, studentMaxScore, studentAvg, 
    									numCurrentStudents, studentLetterGrade, sortOption);
...
// REPORTS =====================================================================
/* =================================================================================
	Function Name: reportOutputLNAscending
	Function Description: displays student information for the report in ascending
	                   order by lastName
								...
								char studentLetterGrade[ ], int sortOption)
{
	...
	for (int row = 0; row < numCurrentStudents; row++)
	{
			printf("\n%-10s %-10s %-8d %-8d %-8d %-8d %-8d %-8.1d %-8.1d %-8.1f %-8c", lastName[row], firstName[row], studentID[row],
