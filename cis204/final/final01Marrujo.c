/*	This program modifys Project 11 to change the search option to:
        1) Display all student information (student ID, first name, last name) 
            in an appropriate format (sorted by last name)
        2) Ask the user for the student ID to search on
...
int main(void)
{
    ...
    readData(firstName, lastName, studentID, studentScores, NUM_INITIAL_STUDENTS);
